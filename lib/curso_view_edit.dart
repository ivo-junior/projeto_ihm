...
class CursoViewEdit extends StatefulWidget {
  CursoModel curso;
  Data data;
  int tab;
  ...
  @override
  CursoViewEditState createState() => new CursoViewEditState();
}

class CursoViewEditState extends State<CursoViewEdit> {
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => new AddVideoview(
                      cursoModel: widget.curso, data: widget.data)));
        },
        icon: Icon(Icons.add),
        label: new Text("Video"),
