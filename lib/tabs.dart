...
import 'package:projeto_ihm/academy.dart';
import 'package:projeto_ihm/quiz_view.dart';
                ...
                body: new ListView(
                  children: <Widget>[
                    ...
                    new ListTile(
                      ...
                      title: new Text("Academy"),
                      onTap: () => Navigator.push(
                          context,
                          new MaterialPageRoute(
                              builder: (context) => new Academy())),
                    ),
                    new ListTile(
                  ...
                  isSearching
                      ? new TextField(
                          ...
                          decoration: new InputDecoration.collapsed(
                              hintText: 'Procure por nomes e symbolos...'),
                        )
                      : new GestureDetector(
                          onTap: () => _startSearch(),
  ...
  Widget _transactionFAB(BuildContext context) {
    return sheetOpen
        ? new FloatingActionButton(
            ...
            elevation: 4.0,
            tooltip: "Fechar Transação",
          )
        : new FloatingActionButton.extended(
            onPressed: _openTransaction,
            icon: Icon(Icons.add),
            label: new Text("Add Transação"),
            foregroundColor: Theme.of(context).iconTheme.color,
            backgroundColor: Theme.of(context).accentIconTheme.color,
            elevation: 4.0,
